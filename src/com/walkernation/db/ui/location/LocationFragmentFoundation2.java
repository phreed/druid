...
public class LocationFragmentFoundation2 extends ListFragment {
	...
	// TAG for logging
	private static final String LOG_TAG = LocationFragmentFoundation2.class
			.getCanonicalName();

	// URI for access to the ContentProvider
	final static Uri uri = ContentDescriptor.Location.CONTENT_URI;

	// interface to talk with the attached Activity
	OnOpenWindowInterface mOpener;

	// fragment that stores the 'state of this fragment'
	...
	/**
	 * 
	 * customized FOR THIS FRAGMENT Methods
	 * 
	 */
	...
	private View createViewForFragment(LayoutInflater inflater,
		...
		// create view
		View rValue = inflater.inflate(R.layout.location_listview, container,
				false);
		// get the ListView that will be displayed
		ListView lv = (ListView) rValue.findViewById(android.R.id.list);
	...
	/**
	 * 
	 * STATE retainment internal Fragment
	 * 
	 * @author Michael A. Walker
	 * 
	 */
