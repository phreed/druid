...
public class DataTwoCreator {

	public static ContentValues getCVfromDataTwo(final DataTwoData data) {
	 ...
	 */
	public static ArrayList<DataTwoData> getDataTwoDataArrayListFromCursor(
			Cursor cursor) {
		ArrayList<DataTwoData> rValue = new ArrayList<DataTwoData>();
		if (cursor != null) {
			cursor.moveToFirst();
			do {
				rValue.add(getDataTwoDataFromCursor(cursor));
	 ...
	 */
	public static DataTwoData getDataTwoDataFromCursor(Cursor cursor) {
