...
public class DruidMojo extends AbstractMojo {
    ...
    */
    ...
    /**
     * skelOutputDirectory : the base path for the skeleton generated files.
     * <p>
     * This indicates where the generated skeleton files should be placed.
     * 
     ...
     *            default-value="${basedir}"
     */
    private File skelOutputDirectory;
    
	/**
	 * pathSet : some of the paths generated by the template
	 * are not placed in the typical output directory such
	 * as the skeleton files.
	 ...
	 * 
	 * @parameter expression="${generate.pathSet}"
	 */
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
		...
		generator.setPathSet(this.pathSet);
